	...
	<div class="seeAll" style="width: 95%;;height: auto;position: absolute;top: 45px;left: 2.5%;border: 4px solid #FFCFB9;background-color: #FFF;display: none;padding-bottom: 20em;">
		...
		<table width="510" class="edit" style="margin-top:10px;margin-left:40px;">
			...
			<tr>
				<td class="left">今日：</td>
				<td class="right">
					<a href="javascript:void(0)">总共: <b><?=$todayAllContent?></b></a>&nbsp;&nbsp; 
					<a href="javascript:void(0)">已到: <b><?=$todayAllCome;  ?></b></a>&nbsp;&nbsp;
					<a href="javascript:void(0)">未到: <b><?=$todayAllNot?></b></a>
				</td>
			</tr>
			<tr>
				<td class="left">昨日：</td>
				<td class="right">
					<a href="javascript:void(0)">总共: <b><?=$yesterdayAllContent?></b></a> &nbsp;&nbsp;
					<a href="javascript:void(0)">已到: <b><?=$yesterdayAllCome?></b></a> &nbsp;&nbsp; 
					<a href="javascript:void(0)">未到: <b><?=$yesterdayAllNot?></b></a></td>
			</tr>
			<tr>
				<td class="left">本月：</td>
				<td class="right">
					<a href="javascript:void(0)">总共: <b><?=$thismonthAllContent?></b></a> &nbsp;&nbsp; 
					<a href="javascript:void(0)">已到: <b><?=$thismonthAllCome?></b></a> &nbsp;&nbsp; 
					<a href="javascript:void(0)">未到: <b><?=$thismonthAllNot?></b></a>
				</td>
			</tr>
			<tr>
				<td class="left" style="color:silver">同比：</td>
			...
			<tr>
				<td class="left">上月：</td>
				<td class="right">
					<a href="javascript:void(0)">总共: <b><?=$lastmonthAllContent?></b></a> &nbsp;&nbsp; 
					<a href="javascript:void(0)">已到: <b><?=$lastmonthAllCome?></b></a> &nbsp;&nbsp; 
					<a href="javascript:void(0)">未到: <b><?=$lastmonthAllNot?></b></a>
				</td>
			</tr>
		</table>
    ...
    <div class="seeAll2" style="width: 95%;;height: auto;position: absolute;top: 45px;left: 2.5%;border: 4px solid #FFCFB9;background-color: #FFF;display: none;padding-bottom: 20em;">
        ...
        <table width="510" class="edit" style="margin-top:10px;margin-left:40px;">
            ...
            <tr>
                <td class="left">今日：</td>
                <td class="right">
                    <a href="javascript:void(0)">总共: <b><?=$todayAllContent_D?></b></a>&nbsp;&nbsp;
                    <a href="javascript:void(0)">已到: <b><?=$todayAllCome_D;  ?></b></a>&nbsp;&nbsp;
                    <a href="javascript:void(0)">未到: <b><?=$todayAllNot_D?></b></a>
                </td>
            </tr>
            <tr>
                <td class="left">昨日：</td>
                <td class="right">
                    <a href="javascript:void(0)">总共: <b><?=$yesterdayAllContent_D?></b></a> &nbsp;&nbsp;
                    <a href="javascript:void(0)">已到: <b><?=$yesterdayAllCome_D?></b></a> &nbsp;&nbsp;
                    <a href="javascript:void(0)">未到: <b><?=$yesterdayAllNot_D?></b></a></td>
            </tr>
            <tr>
                <td class="left">本月：</td>
                <td class="right">
                    <a href="javascript:void(0)">总共: <b><?=$thismonthAllContent_D?></b></a> &nbsp;&nbsp;
                    <a href="javascript:void(0)">已到: <b><?=$thismonthAllCome_D?></b></a> &nbsp;&nbsp;
                    <a href="javascript:void(0)">未到: <b><?=$thismonthAllNot_D?></b></a>
                </td>
            </tr>
            <tr>
                <td class="left" style="color:silver">同比：</td>
            ...
            <tr>
                <td class="left">上月：</td>
                <td class="right">
                    <a href="javascript:void(0)">总共: <b><?=$lastmonthAllContent_D?></b></a> &nbsp;&nbsp;
                    <a href="javascript:void(0)">已到: <b><?=$lastmonthAllCome_D?></b></a> &nbsp;&nbsp;
                    <a href="javascript:void(0)">未到: <b><?=$lastmonthAllNot_D?></b></a>
                </td>
            </tr>
        </table>
