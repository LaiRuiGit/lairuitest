...
;(function($, window, document, undefined) {
	...
	Tree.prototype = {
		...
		// _css: '.list-group-item{cursor:pointer;}.list-group-item:hover{background-color:#f7ecec;}span.indent{margin-left:10px;margin-right:10px}span.icon{margin-right:5px}'
