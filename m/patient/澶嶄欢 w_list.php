...
function mlist()
{
	...
	foreach ($part_today_all as $row)
	{
		...
		<td>{$d_date}</td>
		<td>{$conttent}</td>
		<td><a href=\"w_list_ck.php?id={$id}\" title='查看详情'><img src=\"/res/img/b_detail.gif\" /></a> <a href=\"w_list.edit.php?op=edit&id={$id}&go=back\" title='修改数据'><img src=\"/res/img/b_edit.gif\" /></a> <a href=\"w_list.delete.php?page={$_GET['page']}&id={$id}\" title='删除'><img src=\"/res/img/b_delete.gif\" /></a></td>
	  </tr>";
