...
$type_arr = array(0 => "整个门店", 2 => "网络", 3 => "电话");
...
<div style="text-align:center; padding:20px 0 5px 0;">
	类型：<input type="button" class="buttonb" value="整个门店" onclick="location='?'">&nbsp;
...
<div class="report_tips">各月同期数据对比 (每月<?php echo $day; ?>日内到店数据) (<?php echo $type_arr[intval($_GET["type"])]; ?>)</div>
